...
INSERT INTO PC_USERS (USERNAME, DISPLAY_NAME, PASSWORD, SOME_CONTENT) VALUES ('olivier@lediouris.net', 'Oliv', sha1('c2h5oh'), 'Akeu Coucou!');
INSERT INTO PC_USERS (USERNAME, DISPLAY_NAME, PASSWORD, ADMIN_PRIVILEGES, SOME_CONTENT) VALUES ('admin@passe-coque.com ', 'Administrator', sha1('manager'), TRUE, 'For tests, with Admin Privileges');
