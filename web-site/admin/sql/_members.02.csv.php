      ...
      if ($query->num_rows > 0) { 
          ...
          while ($row = $query->fetch_assoc()) { 
              ...
              $lineData = array($row['ID'], 
                                ...
                                $nlOk, 
                                $admin, 
                                $row['SAILING_EXPERIENCE'], 
                                $row['SHIPYARD_EXPERIENCE'],
                                $row['BIRTH_DATE'],
                                $row['ADDRESS'],
                                $row['2021'],
                                $row['2022'],
...
<html lang="en">
  ...
  <body>
    <h1>PHP / MySQL. Passe-Coque Members, Passeurs d'&Eacute;coute, from the DB, in CSV file</h1>
